...
-- Request
INSERT INTO calculator_request (id, status, creation_datetime, client_id, climate_zone, required_r_value, wall_type, norm_standard) VALUES
(1, 'DRAFT', NOW(), 1, 'Moscow Region', 3.5, 'Brick', 'SNiP 23-02-2003');

-- RequestInsulator
INSERT INTO calculator_requestinsulator (request_id, insulator_id, quantity, "order", is_main, comment) VALUES
